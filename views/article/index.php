    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7 probootstrap-intro-text">
          <h1 class="probootstrap-animate" data-animate-effect="fadeIn">Статьи</h1>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 probootstrap-relative">
            <h2 class="probootstrap-heading mt0 mb50">Статьи</h2>
            ...
            <div class="owl-carousel owl-carousel-carousel">
              ...
              <div class="item">
                <div class="probootstrap-program">
                  <a href="/programs/<?php echo $articleItem['id']; ?>"><?php echo $articleItem['h1']; ?></a><!-- <img src="img/img_1.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive img-rounded"></img> -->
                  <h3></h3>
