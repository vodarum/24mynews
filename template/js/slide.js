function Ant(crslId) {
    ...
    if (id) {
        ...
        this.crslRoot = document.querySelector('.container_slider')
    };
    ...
    this.leftArrow = this.crslRoot.querySelector('div.slider-arrow-left');
    this.rightArrow = this.crslRoot.querySelector('div.slider-arrow-right');
    this.indicatorDots = this.crslRoot.querySelector('div.slider-dots');
...
Ant.initialize = function(that) {
    ...
    if (that.options.dots) { // инициализация индикаторных точек
        ...
        that.indicatorDotsAll = that.crslRoot.querySelectorAll('span.slider-dot');
